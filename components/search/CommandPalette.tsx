...
function CommandPalette() {
  ...
  const eventResults = results.filter((r): r is SearchResult & { type: 'event' } => r.type === 'event')

  // Flat list for keyboard navigation
  const flatResults = [...taskResults, ...noteResults, ...eventResults]
        ...
        >
          ...
          >
            ...
            <div className="max-h-80 overflow-y-auto p-2">
              ...
              {!isPending && eventResults.length > 0 && (
                <div className="mb-1">
                  <div className="px-2 py-1.5 text-xs font-semibold uppercase tracking-wider text-[var(--text-secondary)]">
                    Events
                  </div>
                  {eventResults.map((result) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className="shrink-0 text-xs text-[var(--text-secondary)]">Event</span>
                      </button>
                    )
                  })}
                </div>
